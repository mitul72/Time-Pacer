    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Here's a list of your tasks for this month!</p>
        </div>
        <Button className="bg-green-600 hover:bg-green-700" onClick={() => setIsAddTaskDialogOpen(true)}>
      ...
      <div className="flex items-center space-x-4">
        <div className="relative flex-1">
          ...
          <Input placeholder="Search tasks..." className="pl-10 glass-effect w-full" />
        </div>
          ...
          >
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <span className="text-xs text-green-400 font-medium">{task.id}</span>
                <span className="text-xs px-2 py-1 rounded-full glass-effect">{task.type}</span>
              </div>
              <div className="text-sm font-medium text-blue-100">{task.title}</div>
            </div>
